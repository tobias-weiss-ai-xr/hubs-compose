...
| ⚠️ **known defect** | Feature is **live-broken**; an automated harness (`e2e/epics/ep-04-room-entry.spec.ts`) reproduces the defect and is **intentionally RED** until the platform is fixed. | Harness reports failure (bug present) → must turn green after the fix. |
...
| EP-31 | AI Learning Assistant & Adaptive Tutoring | Sprint 14 | 54–55 | US-242…US-249 |
| EP-32 | Advanced Virtual Laboratory | Sprint 14 | 56–57 | US-250…US-257 |
| EP-33 | Gamification & Motivation | Sprint 15 | 58–59 | US-258…US-265 |
| EP-34 | Multi-Class Collaboration & School Federation | Sprint 15 | 60–61 | US-266…US-273 |
| EP-35 | Inquiry Projects & Student Portfolios | Sprint 16 | 62–63 | US-274…US-281 |
| EP-36 | Guardians & School Reporting | Sprint 16 | 64–65 | US-282…US-289 |
| EP-37 | Responsible Use & Sustainability | Sprint 17 | 66–67 | US-290…US-297 |
| EP-38 | Next-Generation Immersion | Sprint 17 | 68–69 | US-298…US-305 |
...
| Phase 2: EP-31…EP-38 (Sprints 14–17, codons 54–69, US-242…US-305) | 📋 planned | skipped reporting |
...
## EP-31 — AI Learning Assistant & Adaptive Tutoring

> **Goal:** *As a student, I get an in-room AI assistant that explains chemistry at my level in German and adapts exercises to my progress; as a teacher I decide when and how it intervenes.*

### US-242: In-room AI tutor
**As a** student **I want** an assistant I can call in every room **so that** I get help without leaving the lesson.
- **Epic:** EP-31 · **Codons:** 54 · **Status:** 📋 planned
- **Acceptance criteria:**
  - AI-tutor button visible in the room toolbar; opens a chat/speech panel.
  - First answer arrives within 5 seconds on a normal connection.
- **Test:** none yet

### US-243: Curriculum-scoped answers
**As a** student **I want** answers restricted to the course curriculum **so that** the AI neither goes off-topic nor invents unsafe chemistry.
- **Epic:** EP-31 · **Codons:** 54 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Responses reference only the 118-element dataset, the configured course level (e.g. Sek I/II), and uploaded curriculum material.
  - Out-of-scope requests are politely deflected instead of answered.
- **Test:** none yet

### US-244: Step-by-step hints (Socratic)
**As a** student **I want** gradual hints instead of full solutions **so that** I still work through the reasoning myself.
- **Epic:** EP-31 · **Codons:** 55 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Hints are revealed one at a time; the full solution is offered only after several hints or an explicit request.
- **Test:** none yet

### US-245: Level-appropriate language
**As a** student **I want** the tutor to match my German level (basic/intermediate/advanced) **so that** explanations are actually understandable.
- **Epic:** EP-31 · **Codons:** 55 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Language level is selectable per student; the same question yields a simplified vs. technical response.
- **Test:** none yet

### US-246: Teacher control of the assistant
**As a** teacher **I want** to enable/disable and scope the assistant per room **so that** I stay in control of the lesson.
- **Epic:** EP-31 · **Codons:** 55 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Per-room toggle; teacher can whitelist topics and set the maximum hint depth.
- **Test:** none yet

### US-247: Adaptive exercise difficulty
**As a** student **I want** exercises to adapt to my performance **so that** I am neither bored nor overwhelmed.
- **Epic:** EP-31 · **Codons:** 55 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Difficulty rises after several consecutive correct answers and drops after repeated mistakes; tracked per curriculum unit.
- **Test:** none yet

### US-248: Misconception detection
**As a** student **I want** the system to recognize common chemistry misconceptions (e.g. conservation of mass) and correct them **so that** I do not internalize wrong ideas.
- **Epic:** EP-31 · **Codons:** 55 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Answers matching known misconception patterns trigger a targeted explanation instead of a plain right/wrong verdict.
- **Test:** none yet

### US-249: AI quality & safety guardrails
**As a** teacher **I want** AI answers logged and auditable **so that** students are never exposed to unsafe or wrong content.
- **Epic:** EP-31 · **Codons:** 55 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Interactions are logged per session; teacher can view and report answers; harmful requests (weapon synthesis, hazardous instructions) are blocked.
- **Test:** none yet

## EP-32 — Advanced Virtual Laboratory

> **Goal:** *As a student, I can perform a much wider range of chemistry experiments safely in VR or browser; as a teacher I can tailor them to the curriculum.*

### US-250: Extended reaction library
**As a** student **I want** more simulated reactions beyond NaCl and H₂O (acid-base, redox, precipitation, combustion) **so that** the curriculum's full scope is covered.
- **Epic:** EP-32 · **Codons:** 56 · **Status:** 📋 planned
- **Acceptance criteria:**
  - The library covers the course curriculum list (at least 40 reactions); every reaction has a correct balanced equation.
- **Test:** none yet

### US-251: Stoichiometry calculator
**As a** student **I want** reagent amounts with live yield/mass calculation **so that** I learn quantitative relationships.
- **Epic:** EP-32 · **Codons:** 56 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Changing an amount updates mole counts, the limiting reagent, and product mass in real time.
- **Test:** none yet

### US-252: Titration simulation
**As a** student **I want** a virtual titration (burette, indicator, endpoint) **so that** I practice a classic lab skill safely.
- **Epic:** EP-32 · **Codons:** 56 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Drop-by-drop control; indicator color change at the endpoint; live pH curve.
- **Test:** none yet

### US-253: Gas-law experiments
**As a** student **I want** gas experiments (Boyle, Charles, Gay-Lussac) with adjustable parameters **so that** I can verify the gas laws.
- **Epic:** EP-32 · **Codons:** 56 · **Status:** 📋 planned
- **Acceptance criteria:**
  - P/V/T sliders produce the correct relations; plotted curves match the predicted isotherms/isobars.
- **Test:** none yet

### US-254: Safety-grade experiment levels
**As a** teacher **I want** experiments labeled with real lab-safety levels **so that** students practice appropriate precautions.
- **Epic:** EP-32 · **Codons:** 57 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Each simulation shows a hazard label and required PPE; unsafe actions are warned and locked.
- **Test:** none yet

### US-255: Consequences for wrong procedure
**As a** student **I want** realistic consequences for wrong procedural steps **so that** I learn safe lab behavior.
- **Epic:** EP-32 · **Codons:** 57 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Omissions (no goggles, wrong order) trigger warnings; severe violations abort the simulation.
- **Test:** none yet

### US-256: Printable lab report
**As a** student **I want** to export my experiment (setup, data, results) as a lab report **so that** I can hand it in.
- **Epic:** EP-32 · **Codons:** 57 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Report contains objective, procedure, data table, calculations, and conclusion; exports as PDF.
- **Test:** none yet

### US-257: Teacher experiment templates
**As a** teacher **I want** to create and share custom experiment templates **so that** they match the school curriculum.
- **Epic:** EP-32 · **Codons:** 57 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Template editor with simulation parameters; templates reusable across classes.
- **Test:** none yet

## EP-33 — Gamification & Motivation

> **Goal:** *As a student, learning feels rewarding and habit-forming; as a teacher I decide when and how gamification is shown to keep it constructive.*

### US-258: XP and levels
**As a** student **I want** experience points for learning activities **so that** progress feels rewarding.
- **Epic:** EP-33 · **Codons:** 58 · **Status:** 📋 planned
- **Acceptance criteria:**
  - XP is awarded for completing quizzes, labs, and lessons; a level indicator is shown in the profile.
- **Test:** none yet

### US-259: Badges and achievements
**As a** student **I want** achievements (e.g. "Element Master", "First Titration") **so that** I get recognition.
- **Epic:** EP-33 · **Codons:** 58 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Badges persist on the profile; a notification is shown when one unlocks.
- **Test:** none yet

### US-260: Streaks and daily goals
**As a** student **I want** streaks and daily learning goals **so that** I build a routine.
- **Epic:** EP-33 · **Codons:** 58 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Consecutive active days are tracked; a streak-freeze option exists; goals are teacher-configurable.
- **Test:** none yet

### US-261: Privacy-respecting class leaderboard
**As a** student **I want** a class leaderboard **so that** I can compare progress, while the teacher decides whether it is visible at all.
- **Epic:** EP-33 · **Codons:** 58 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Leaderboard is teacher opt-in; names are pseudonymous unless the class allows real names; hidden outside the class window.
- **Test:** none yet

### US-262: Quest arcs
**As a** student **I want** themed quest chains (e.g. "Journey through the periodic table") **so that** learning has narrative structure.
- **Epic:** EP-33 · **Codons:** 59 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Quests unlock in order; completion is rewarded; arcs reset each term.
- **Test:** none yet

### US-263: Effort over talent
**As a** student **I want** gamification to reward effort and improvement **so that** weaker students are not discouraged.
- **Epic:** EP-33 · **Codons:** 59 · **Status:** 📋 planned
- **Acceptance criteria:**
  - XP includes improvement and completion, not only speed or score; there are no public shaming states.
- **Test:** none yet

### US-264: Seasonal events
**As a** student **I want** limited chemistry events (e.g. Mole Day) **so that** the platform stays motivating.
- **Epic:** EP-33 · **Codons:** 59 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Event templates are time-boxed and admin-configurable; events do not affect grades.
- **Test:** none yet

### US-265: Gamification reset and control
**As a** teacher **I want** to switch gamification on/off and reset progress **so that** I keep the class focused.
- **Epic:** EP-33 · **Codons:** 59 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Per-class toggle; term progress can be reset; export occurs before reset.
- **Test:** none yet

## EP-34 — Multi-Class Collaboration & School Federation

> **Goal:** *As a teacher and admin, classes, schools, and instances can collaborate in a safe, quota-bound way.*

### US-266: Cross-class shared lab
**As a** teacher **I want** to invite another class into a shared lab **so that** classes can collaborate.
- **Epic:** EP-34 · **Codons:** 60 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Cross-class room tokens grant guest-teacher/guest-student roles; both classes appear in the room.
- **Test:** none yet

### US-267: Co-teaching roles
**As a** teacher **I want** a second teacher co-hosting a room **so that** team teaching works.
- **Epic:** EP-34 · **Codons:** 60 · **Status:** 📋 planned
- **Acceptance criteria:**
  - The co-host receives equal moderation rights; the origin teacher can revoke them.
- **Test:** none yet

### US-268: School-domain SSO
**As a** school admin **I want** single sign-on with the school domain (SAML/OIDC) **so that** students use their school identity.
- **Epic:** EP-34 · **Codons:** 60 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Configured identity providers work; accounts are provisioned automatically; roles are mapped.
- **Test:** none yet

### US-269: Public element-room federation
**As a** student **I want** to see public element rooms from partner schools **so that** the community is bigger than one instance.
- **Epic:** EP-34 · **Codons:** 61 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Federation-enabled instances exchange public element-room listings (opt-in); cross-instance join URLs work.
- **Test:** none yet

### US-270: Shared element content
**As a** teacher **I want** to publish element content to a shared catalog **so that** good material is reused.
- **Epic:** EP-34 · **Codons:** 61 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Publication with a license; versioning; authors/admins can take content down.
- **Test:** none yet

### US-271: Cross-instance quotas
**As an** admin **I want** per-school quotas and rate limits in the federation **so that** no partner overwhelms the platform.
- **Epic:** EP-34 · **Codons:** 61 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Quotas are enforced per instance token; exceeded requests get a clear error.
- **Test:** none yet

### US-272: Trust and reputation levels
**As an** admin **I want** partner trust levels (vetted/standard) **so that** federation stays safe.
- **Epic:** EP-34 · **Codons:** 61 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Trust level gates what partners may publish or broadcast; it can be revoked.
- **Test:** none yet

### US-273: Multi-instance monitoring
**As an** admin **I want** federation health visible **so that** partner outages or abuse are spotted early.
- **Epic:** EP-34 · **Codons:** 61 · **Status:** 📋 planned
- **Acceptance criteria:**
  - A dashboard shows partner latency, error rate, and blocked instances.
- **Test:** none yet

## EP-35 — Inquiry Projects & Student Portfolios

> **Goal:** *As a student, I can pursue my own chemistry questions in structured projects and keep a portfolio; as a teacher I can assign and grade them.*

### US-274: Hypothesis workspace
**As a** student **I want** to state a hypothesis before experimenting **so that** I practice inquiry skills.
- **Epic:** EP-35 · **Codons:** 62 · **Status:** 📋 planned
- **Acceptance criteria:**
  - A hypothesis field is tied to the chosen experiment; entries can be revised and versioned.
- **Test:** none yet

### US-275: Open-ended experiment sandbox
**As a** student **I want** to combine substances freely (within safety limits) **so that** I can explore my own questions.
- **Epic:** EP-35 · **Codons:** 62 · **Status:** 📋 planned
- **Acceptance criteria:**
  - The sandbox enforces safety rules and records every step for replay.
- **Test:** none yet

### US-276: Project notebook
**As a** student **I want** a structured notebook (question → hypothesis → plan → data → conclusion) **so that** my project is organized.
- **Epic:** EP-35 · **Codons:** 62 · **Status:** 📋 planned
- **Acceptance criteria:**
  - The notebook auto-populates from simulation actions; it is editable and saved per project.
- **Test:** none yet

### US-277: Data export for analysis
**As a** student **I want** to export my experiment data (CSV) **so that** I can analyze it in other tools.
- **Epic:** EP-35 · **Codons:** 62 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Export includes all measured variables with units and timestamps.
- **Test:** none yet

### US-278: Project gallery
**As a** student **I want** to share my finished project in a class gallery **so that** others can learn from it.
- **Epic:** EP-35 · **Codons:** 63 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Public projects require teacher approval; comments are allowed; the student can hide/show their own project.
- **Test:** none yet

### US-279: Peer feedback
**As a** student **I want** rubric-based peer feedback **so that** we improve together.
- **Epic:** EP-35 · **Codons:** 63 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Rubric scoring; optional anonymity; the teacher moderates feedback.
- **Test:** none yet

### US-280: Portfolio across terms
**As a** student **I want** all projects collected in a portfolio **so that** I can show my growth.
- **Epic:** EP-35 · **Codons:** 63 · **Status:** 📋 planned
- **Acceptance criteria:**
  - The portfolio lists projects per term, is exportable, and is archived when leaving.
- **Test:** none yet

### US-281: Teacher project management
**As a** teacher **I want** to assign, monitor, and grade projects **so that** inquiry work stays manageable.
- **Epic:** EP-35 · **Codons:** 63 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Assignment deadlines; a progress dashboard; rubric grading imported into the gradebook.
- **Test:** none yet

## EP-36 — Guardians & School Reporting

> **Goal:** *As a guardian and school admin, I can follow a child's learning and ensure data protection, without burdening teachers.*

### US-282: Guardian dashboard
**As a** guardian **I want** a read-only view of my child's learning **so that** I can support them at home.
- **Epic:** EP-36 · **Codons:** 64 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Shows topics studied and quiz results (no raw class comparisons) plus teacher notes; access is consent-based.
- **Test:** none yet

### US-283: Progress digest (opt-in e-mail)
**As a** guardian **I want** a periodic summary e-mail **so that** I stay informed without logging in daily.
- **Epic:** EP-36 · **Codons:** 64 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Weekly or monthly digest; easy unsubscribe; no sensitive data in the subject line.
- **Test:** none yet

### US-284: Consent management
**As a** school admin **I want** consent records for minors (photos, AI tutor, federation) **so that** we comply with data-protection law.
- **Epic:** EP-36 · **Codons:** 64 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Per-feature consent capture; features stay blocked until consent; consent is revocable.
- **Test:** none yet

### US-285: Teacher → guardian messages
**As a** teacher **I want** to message guardians with approved templates **so that** communication is simple and safe.
- **Epic:** EP-36 · **Codons:** 65 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Messages go through the school account; replies are routed to the teacher; an audit trail exists.
- **Test:** none yet

### US-286: Term report export
**As a** teacher **I want** a term report per student (participaton, quizzes, projects) **so that** school reporting is fast.
- **Epic:** EP-36 · **Codons:** 65 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Generated PDF with an editable summary and a teacher comment field.
- **Test:** none yet

### US-287: Parent-teacher conference data
**As a** teacher **I want** a compact summary sheet for conferences **so that** meetings are productive.
- **Epic:** EP-36 · **Codons:** 65 · **Status:** 📋 planned
- **Acceptance criteria:**
  - One-page sheet with key metrics and talking points.
- **Test:** none yet

### US-288: Guardian language choice
**As a** guardian **I want** reports in my own language **so that** I understand them.
- **Epic:** EP-36 · **Codons:** 65 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Dashboard and digest follow the guardian's language; summary text can be auto-translated.
- **Test:** none yet

### US-289: Data access requests
**As a** school admin **I want** to honor access/export/deletion requests from guardians **so that** we comply with GDPR.
- **Epic:** EP-36 · **Codons:** 65 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Workflow for requests; export package; deletion with documented retention exceptions.
- **Test:** none yet

## EP-37 — Responsible Use & Sustainability

> **Goal:** *As a student, teacher, and admin, the platform runs on weak hardware and weak connections and keeps its energy footprint low.*

### US-290: Energy-aware rendering
**As a** student **I want** a low-power mode reducing effects **so that** old devices and batteries last longer.
- **Epic:** EP-37 · **Codons:** 66 · **Status:** 📋 planned
- **Acceptance criteria:**
  - A toggle reduces shadows and fidelity; the same lesson content stays accessible.
- **Test:** none yet

### US-291: Low-bandwidth mode
**As a** student **I want** a low-data mode **so that** I can learn over weak connections.
- **Epic:** EP-37 · **Codons:** 66 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Reduces texture quality and avatar detail; core interaction is preserved; estimated savings are shown.
- **Test:** none yet

### US-292: CO₂-aware scheduling
**As an** admin **I want** heavy jobs (rendering, AI batch) scheduled when green energy is cheap **so that** the platform lowers its footprint.
- **Epic:** EP-37 · **Codons:** 66 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Scheduler window is configurable; the dashboard shows the energy mix used.
- **Test:** none yet

### US-293: Hardware tiering
**As an** admin **I want** automatic fallback tiers per device **so that** we do not over-provision for everyone.
- **Epic:** EP-37 · **Codons:** 66 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Tiers derive from device capability; effect on server load is observable.
- **Test:** none yet

### US-294: Digital-wellbeing timer
**As a** student **I want** optional session reminders **so that** extended VR sessions stay healthy.
- **Epic:** EP-37 · **Codons:** 67 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Configurable break reminders; enforced pauses for young accounts per school policy.
- **Test:** none yet

### US-295: Screen-time summary for teachers
**As a** teacher **I want** an anonymized class screen-time summary **so that** I can advise balanced use.
- **Epic:** EP-37 · **Codons:** 67 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Aggregates only, no per-student shaming data; a class may opt out.
- **Test:** none yet

### US-296: Media-heavy room labels
**As a** teacher **I want** a label on media-heavy rooms **so that** I can choose lighter alternatives.
- **Epic:** EP-37 · **Codons:** 67 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Rooms show estimated data size; a lighter scene is suggested.
- **Test:** none yet

### US-297: Green reporting for admins
**As an** admin **I want** a sustainability report (energy, bandwidth per service) **so that** we can optimize.
- **Epic:** EP-37 · **Codons:** 67 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Monthly report with per-service breakdown and trend.
- **Test:** none yet

## EP-38 — Next-Generation Immersion

> **Goal:** *As a student, interaction in the VR laboratory becomes more natural — voice, agents, haptics, and shared annotation.*

### US-298: Voice control in VR
**As a** student **I want** voice commands (e.g. "zoom to sodium") **so that** I can act without menus.
- **Epic:** EP-38 · **Codons:** 68 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Core commands work in headset and browser; feedback is given with a UI fallback.
- **Test:** none yet

### US-299: AI teaching agents in rooms
**As a** student **I want** an AI agent (e.g. a virtual lab assistant) present in the room **so that** help feels human.
- **Epic:** EP-38 · **Codons:** 68 · **Status:** 📋 planned
- **Acceptance criteria:**
  - The agent has an avatar and voice, answers in-room, and the teacher can spawn/dismiss it.
- **Test:** none yet

### US-300: Haptic feedback prototype
**As a** student **I want** optional device vibration for interactions **so that** immersion deepens.
- **Epic:** EP-38 · **Codons:** 68 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Supported controllers vibrate on defined events; toggleable; no impact on non-haptic devices.
- **Test:** none yet

### US-301: Spatial audio zones
**As a** student **I want** zone-based spatial audio (e.g. louder near the periodic table) **so that** rooms feel real.
- **Epic:** EP-38 · **Codons:** 68 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Volume depends on distance/zone; configurable per room.
- **Test:** none yet

### US-302: Persistent 3D annotation notes
**As a** student **I want** to place persistent notes at 3D positions **so that** teams annotate models together.
- **Epic:** EP-38 · **Codons:** 69 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Notes persist per session/room; visibility follows roles; synced via the entity channel.
- **Test:** none yet

### US-303: Teacher-pinned camera view
**As a** student **I want** the teacher to pin a camera view **so that** everyone sees the same demonstration.
- **Epic:** EP-38 · **Codons:** 69 · **Status:** 📋 planned
- **Acceptance criteria:**
  - Pinned view follows the teacher's screen/object; students can unpin individually.
- **Test:** none yet

### US-304: Shared whiteboard with chemistry palettes
**As a** student **I want** a whiteboard with formula/tool palettes **so that** we can draw equations together.
- **Epic:** EP-38 · **Codons:** 69 · **Status:** 📋 planned
- **Acceptance criteria:**
  - The palette inserts subscripts, superscripts, and arrows; content syncs live to all.
- **Test:** none yet

### US-305: Immersion settings profile
**As a** student **I want** my immersion settings (voice, haptics, cameras) saved per device **so that** setup is instant.
- **Epic:** EP-38 · **Codons:** 69 · **Status:** 📋 planned
- **Acceptance criteria:**
  - The profile applies automatically per device; a reset option exists.
- **Test:** none yet
