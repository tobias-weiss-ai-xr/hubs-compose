#!/bin/bash
# verify-infra-all.sh — aggregate runner for all 7 infrastructure verification
# scripts.
#
# Executes:
...
#
# Run with: bash tests/verify-infra-all.sh
#
# Conventions honored:
...
# The 7 infrastructure verification scripts, in execution order.
SCRIPTS=(
...
echo "=========================================="
echo "Infrastructure Verification — Aggregate Runner"
echo "  7 sub-scripts: docker health, traefik, reticulum,"
echo "  TLS cert, spoke+admin, TURN, client bundles"
echo "=========================================="
...
# ---------------------------------------------------------------------------
# Run all 7 sub-scripts. Each runs to completion; failures are collected and
