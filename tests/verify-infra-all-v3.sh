#!/bin/bash
# verify-infra-all-v3.sh — aggregate runner for ALL infrastructure tests
# (Batch 2 + Batch 3 + Batch 4).
#
# Executes all 18 sub-scripts in sequence:
#   Batch 2 (7 tests):
...
#
# Run with: bash tests/verify-infra-all-v3.sh
...
echo "=========================================="
echo "Infrastructure Verification — Aggregate Runner v3"
echo "  19 sub-scripts: 7 Batch 2 + 12 Batch 3/4"
echo "=========================================="
